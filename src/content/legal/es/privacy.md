...
Esta política se aplica únicamente a esta web. Las aplicaciones móviles y otras webs que gestionamos o alojamos tienen sus propias políticas de privacidad.

## 1. Responsable del tratamiento

El responsable del tratamiento es Lucsoft SL. Los datos de la empresa y de contacto figuran en esta página. Para cualquier consulta o solicitud relacionada con la privacidad, escríbenos a la dirección de email indicada.

## 2. Qué datos recogemos

**Cuando contactas con nosotros** a través del formulario, por email, teléfono o WhatsApp, recibimos la información que decides compartir, por ejemplo:

- tu nombre y dirección de email
...
Algunos de estos proveedores están ubicados fuera del Espacio Económico Europeo, principalmente en Estados Unidos. En esos casos, las transferencias se amparan en una decisión de adecuación (como el Marco de Privacidad de Datos UE-EE. UU.) o en las Cláusulas Contractuales Tipo de la Comisión Europea.

También podemos comunicar datos cuando lo exija la ley, por ejemplo a la Agencia Tributaria a efectos de facturación.
...
- solicitar la rectificación de datos inexactos o la supresión de tus datos
- oponerte a determinados tratamientos o solicitar su limitación
- recibir tus datos en un formato portable
- retirar tu consentimiento, sin que ello afecte al tratamiento realizado antes de retirarlo

Para ejercer estos derechos, escríbenos desde la dirección con la que contactaste o incluye información suficiente para identificarte. Te responderemos en el plazo de un mes.

Si consideras que no hemos tratado tus datos correctamente, puedes presentar una reclamación ante la Agencia Española de Protección de Datos ([www.aepd.es](https://www.aepd.es)).

## 8. Seguridad

Aplicamos medidas técnicas y organizativas adecuadas para proteger los datos personales, como conexiones cifradas (HTTPS) en toda la web y cuentas con acceso controlado para nuestro email y nuestras herramientas.

## 9. Menores

Esta web está dirigida a empresas y no está pensada para menores de 14 años. No recogemos sus datos de forma consciente.

## 10. Cambios en esta política

Podemos actualizar esta política ocasionalmente. La fecha de "última actualización" que aparece en esta página indica siempre la versión vigente.
